...
cd ~
git clone https://github.com/vtnplus/nodejs-pool.git  # Change this depending on how the deployment goes.
cd /usr/src/gtest
sudo cmake .
sudo make
...
cd ~
git clone https://github.com/vtnplus/poolui.git
cd poolui
npm install
./node_modules/bower/bin/bower update
./node_modules/gulp/bin/gulp.js build
cd build
sudo cp ~/poolui/build/globals.default.js ~/poolui/build/globals.js 
